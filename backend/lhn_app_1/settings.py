"""
Django settings for lhn_app_1 project.
...
WSGI_APPLICATION = 'lhn_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lhn_app_1 API",
    "DESCRIPTION": "API documentation for lhn_app_1 App",
    "VERSION": "v1",
}
